...
export const ITEM_VALUE_KIND: Record<ShopItemId, ItemValueKind> = {
  ...
  prism: "points",
  the_catechism: "points",
  litany: "points",
  dismissal: "diceModified",
  winnowing: "diceModified",
  excommunication: "diceModified",
  two_novices: "diceAdded",
  the_calling: "diceAdded",
  the_resonant_hall: "points",
  harmonics: "points",
  the_multitude: "diceAdded",
  abstinence: "goldReturned",
  gilded_altar: "points",
  the_endowment: "points",
  compound_interest: "points",
  a_new_voice: "diceAdded",
  counterpoint: "points",
  the_canticle: "points",
  the_choirmaster: "diceModified",
  plainsong: "points",
  descant: "points",
  a_full_choir: "diceAdded",
  antiphon: "points",
  ascension: "diceModified",
  two_elders: "diceAdded",
  ballast: "diceModified",
  exaltation: "diceModified",
  the_scales: "points",
  gravitas: "points",
  the_weight_of_ages: "points",
  gravity_well: "points",
  the_ancestors: "diceAdded",
  the_anvil: "diceModified",
  an_offering: "diceModified",
  tinder: "diceAdded",
  kindling: "points",
  from_the_ashes: "diceAdded",
  the_pyre: "points",
  everflame: "points",
  the_brazier: "diceModified",
  embers: "points",
  the_ashen_crown: "points",
  a_parting: "diceModified",
  the_cell: "points",
  anointing: "diceModified",
  the_vigil: "points",
  discipline: "points",
  lucky_seven: "points",
